...
class RoomViewTest(TestCase):
    ...
    @patch('django_chat.chat_storage.ChatStorage.get_chat', return_value=[])
    ...
    @patch('django_chat.chat_storage.ChatStorage.get_chat', return_value=[{'user': 1, 'content': 'test message', 'room': 'test-room'}, {'user': 2, 'content': 'another test message', 'room': 'test-room'}])
